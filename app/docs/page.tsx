  ...
  useEffect(() => {
    ...
    const runSequence = async () => {
      ...
      setTimeout(() => {
        ...
        setTimeout(() => {
          setIsMouseRunning(false);
          setAiResponse("Artificial intelligence is a technology that allows you to generate, classify, and perform tasks like image analysis and speech recognition.");
          setCurrentStep(10);
        }, 4000);
      }, 12500);
